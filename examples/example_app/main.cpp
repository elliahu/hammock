...
int main() {
    ...
    auto BUFFER_RESOURCE_HANDLE = dependencyGraph->buffer(LogicalBufferResource{
        .type = BufferType::DeviceOnly,
        .usage = BufferUsage::StorageBuffer,
        .instanceSize = sizeof(math::Vec3),
        .instanceCount = 10u
    });

    auto TARGET_RESOURCE_HANDLE = dependencyGraph->image(LogicalImageResource{
