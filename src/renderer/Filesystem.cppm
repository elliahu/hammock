...
namespace hammock::renderer::filesystem {
    ...
    export std::vector<char> readFile(const std::string &filePath) {
    ...
    /// Dump date into file
    export void dump(const std::string &filename, const std::string &data) {
    ...
    export std::vector<std::string> ls(const std::string &directoryPath) {
    ...
    export void writeImagePng(const std::string &filename, const int width, const int height, const int channels,
    ...
    export void writeImageJpg(const std::string &filename, const int width, const int height, const int channels,
    ...
    export void writeImageHdr(const std::string &filename, const int width, const int height, const int channels,
                              const float *data) {
    ...
    export void writeImageBmp(const std::string &filename, const int width, const int height, const int channels,
                              const void *data) {
    ...
    /// Write contents into bmp image
    export void writeImageTga(const std::string &filename, const int width, const int height, const int channels,
                              const void *data) {
